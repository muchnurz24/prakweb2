...
<body>
    <div class="container">
        <br>
        <h3>Belanja Online Flash Sale</h3>
        <hr>
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">TV : Rp. 4.000.000</li>
                            <li class="list-group-item">Kulkas : Rp. 3.500.000</li>
        ...
        if ($pilih_produk == "TV" ){
            $total_harga = $jumlah_beli * 4000000;
        }elseif ($pilih_produk == "Kulkas"){
            $total_harga = $jumlah_beli * 3500000;
